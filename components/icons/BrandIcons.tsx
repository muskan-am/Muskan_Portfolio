...
export function GithubIcon({ size = 18, color = "currentColor", className, style }: IconProps) {
  return (
    <svg
...
export function LinkedinIcon({ size = 18, color = "currentColor", className, style }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
...
export function TwitterIcon({ size = 18, color = "currentColor", className, style }: IconProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      width={size}
